            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <a class="font-medium text-blue-700 dark:text-blue-600 hover:underline" href="{{ route("projects.create") }}">Add new Project</a>
                        ...
                        <table class="w-full text-sm text-left mt-4 text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th class="px-6 py-3" scope="col">Assign to</th>
                            ...
                            <tbody>
                                @foreach ($projects as $project)
                                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                            <a class="font-medium text-black dark:text-blue-500 hover:underline" href="{{ route("projects.edit", $project) }}">Edit</a>
