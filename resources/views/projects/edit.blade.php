                    ...
                    <div class="w-full mx-auto sm:rounded-lg">
                        <form action="{{ route('projects.update', $project) }}" method="POST">
                            ...
                            <div>
                                ...
                                <x-text-input :value="old('title', $project->title)" autocomplete="title" autofocus class="block mt-1 w-full" id="title" name="title" type="text" />
                            ...
                            <div class="mt-4">
                                ...
                                <textarea class="block mt-1 w-full border-gray-300 focus:border-indigo-500 rounded-md shadow-sm" id="description" name="description">{{ old('description', $project->description) }}</textarea>
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input :value="old('deadline_at', $project->deadline_at)" class="block mt-1 w-full" id="deadline_at" name="deadline_at" type="date" />
