                        ...
                        <form method="POST" action="{{ route('clients.store') }}">
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="contact_email" class="block mt-1 w-full" type="email" name="contact_email" :value="old('contact_email')" required autocomplete="email" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="contact_phone_number" class="block mt-1 w-full" type="tel" name="contact_phone_number" :value="old('contact_phone_number')" required autocomplete="email" />
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="company_address" class="block mt-1 w-full" type="text" name="company_address" :value="old('company_address')" required autocomplete="address" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="company_city" class="block mt-1 w-full" type="text" name="company_city" :value="old('company_city')" required autocomplete="city" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="company_zip" class="block mt-1 w-full" type="text" name="company_zip" :value="old('company_zip')" required autocomplete="zip" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="company_vat" class="block mt-1 w-full" type="text" name="company_vat" :value="old('company_vat')" required autocomplete="vat" />
